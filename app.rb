...
['/', '/about', '/portraits', '/family', '/children', '/engagement', '/newborn', '/wedding'].each do |path|
	get path do
		@current_path = path
    ...
    if @current_path == '/'
      ...
      folder = @current_path.match(/portraits|family|children|engagement|newborn|wedding/).to_s
